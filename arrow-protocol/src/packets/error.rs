...
pub enum PacketError {
    ...
    BuildingJsonFailed,
    /// Returned when a packet can not be matched to one of the defined packet structs
...
impl Display for PacketError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::NoMatchingPacketFound => {
                write!(f, "Packet could not be matched. Packet either unknown, not found or not implemented.")
            }
        }
    }
}
