...
pub mod clientbound {
    ...
    impl JoinGame {
        ...
        pub fn new(entity_id: i32, gamemode: Gamemode, dimension: Dimension, hashed_seed: i64,
            max_players: VarInt, level_type: LevelType, view_distance: VarInt, reduced_debug_info: bool, enable_respawn_screen: bool
        ) -> Self {
            Self {
                entity_id,
                gamemode,
